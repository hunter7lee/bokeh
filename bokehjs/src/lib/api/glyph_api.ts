...
export abstract class GlyphAPI {
  ...
  arrow(...args: unknown[]): TypedGlyphRenderer<Arrow> {
    return this._glyph(Arrow, ["x0", "y0", "x1", "y1"], args)
  }
  ...
  html_text(...args: unknown[]): TypedGlyphRenderer<HTMLText> {
    return this._glyph(HTMLText, ["x", "y", "text"], args)
  }
  ...
  mathml(...args: unknown[]): TypedGlyphRenderer<MathML> {
    return this._glyph(MathML, ["x", "y", "text"], args)
  }
  ...
  tex(...args: unknown[]): TypedGlyphRenderer<TeX> {
    return this._glyph(TeX, ["x", "y", "text"], args)
  }
